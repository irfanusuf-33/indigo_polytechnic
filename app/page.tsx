    ...
    <main className="font-pop">
      <section className="flex flex-col items-center justify-center overflow-hidden bg-[#F2F3F4] px-6 pb-0 pt-8 sm:pt-12 lg:pt-16">
        ...
        <Link
          ...
          className="mt-8 flex items-center gap-4 rounded-full bg-[#0C06DA] py-2 pl-4 pr-4 font-medium text-white transition hover:bg-[#0a05b8]"
        >
          Apply Now
      ...
      <section className="bg-[#EEF0FC] px-6 py-20">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-[0.8fr_1fr]">
          <div>
            ...
            <Link
              href="/courses"
              className="mt-8 flex w-fit items-center gap-2 rounded-lg bg-[#0C06DA] px-5 py-3 text-md font-pop font-normal text-white transition hover:bg-[#0a05b8]"
            >
              Browse All Courses
              <Image
