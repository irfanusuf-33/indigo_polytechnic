  ...
  return (
    <main className="font-pop">
      ...
      <section className="px-6 py-14 sm:py-20">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-stretch gap-8 lg:grid-cols-[0.9fr_0.9fr_1fr] lg:gap-10">
          <div className="flex flex-col gap-3">
            ...
            <div className="relative h-full min-h-[220px] w-full flex-1 overflow-hidden rounded-lg sm:min-h-[300px] lg:min-h-[350px]">
              <Image
          ...
          <div className="relative h-full min-h-[220px] w-full overflow-hidden rounded-lg sm:min-h-[300px] lg:min-h-[350px]">
            <Image
          ...
          <div>
            ...
            <h2 className="text-xl font-bold leading-tight text-[#000000] sm:text-2xl lg:text-3xl">
      ...
      <section className="bg-[#EEF0FC] px-6 py-14 sm:py-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="text-2xl font-bold leading-snug text-[#000000] sm:text-3xl lg:text-4xl">
            Everything You Need for
            <br />
            <span className="text-[#0C06DA]">Career-Focused</span> Learning
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm text-[#8A8A8A] sm:text-base">
      ...
      <section className="flex flex-col items-center px-6 py-14 text-center sm:py-20">
        ...
        <h2 className="font-pop text-2xl font-bold text-[#000000] sm:text-3xl lg:text-4xl">
          Learning <span className="font-pop text-[#0C06DA]">Beyond</span> the
          Classroom
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-sm text-[#8A8A8A] sm:text-base font-pop">
        ...
        <div className="mt-10 flex w-full max-w-5xl flex-col items-center gap-10 lg:flex-row lg:items-start lg:justify-center lg:gap-0">
          <div className="flex flex-col items-center">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border-2 border-[#0C06DA] text-xl font-bold text-[#000000]">
              1
            </div>
            <h3 className="mt-6 text-center font-semibold text-[#000000]">
              Enroll
            </h3>
            <p className="mt-2 max-w-[220px] text-center text-xs leading-4 text-[#8A8A8A]">
              Begin your learning journey with easy enrollment and guidance.
            </p>
          </div>

          <div className="hidden flex-1 border-t-2 border-dotted border-[#0C06DA] lg:mt-8 lg:-mx-2 lg:block" />
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-6 max-w-[220px] text-center font-semibold text-[#000000]">
              Industry Projects
            </h3>
            <p className="mt-2 max-w-[220px] text-center text-xs leading-4 text-[#8A8A8A]">
      ...
      <section className="flex flex-col items-center px-6 pb-14 pt-5 text-center sm:pb-20">
        <span className="mb-6 flex items-center gap-2 rounded-full bg-[#09049B] px-4 py-1.5 text-xs font-semibold uppercase italic tracking-wide text-white">
          <span className="h-1.5 w-1.5 rounded-full bg-white" />
          Why Choose Us
        </span>
        ...
        <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-x-12 gap-y-12 sm:grid-cols-3 sm:mt-14">
          <div className="relative">
            ...
            <div className="relative min-h-[240px] rounded-[24px] border border-[#E5E5E5] bg-white px-6 pb-6 pt-7 shadow-[0_2px_8px_rgba(0,0,0,0.08)] sm:min-h-[270px] sm:px-7">
